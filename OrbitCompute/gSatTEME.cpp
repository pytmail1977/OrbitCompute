...
gSatTEME::gSatTEME(const char *pstrName, double epochJD,double ecco,double argpo,double inclo,double mo,double no,double nodeo)
{
    double startmfe, stopmfe, deltamin;
    double ro[3] = {};
    double vo[3] = {};
   ...
   // twoline2rv(pstrTleLine1, pstrTleLine2, TYPERUN_SET, TYPEINPUT_SET, OPSMODE_SET, CONSTANTS_SET,
     //          startmfe, stopmfe, deltamin, satrec);
    setSatRec(TYPERUN_SET, TYPEINPUT_SET, OPSMODE_SET, CONSTANTS_SET,epochJD,ecco,argpo,inclo,mo,no,nodeo,satrec);
...
void gSatTEME::resetPara( double epochJD,double ecco,double argpo,double inclo,double mo,double no,double nodeo)
{
    double startmfe, stopmfe, deltamin;
    double ro[3] = {};
    double vo[3] = {};
...
Vec3d gSatTEME::computeSubPoint(gTime ai_Time)
{
	...
	Vec3d resultVector(3); // (0) Latitude, (1) Longitude, (2) altitude
