...
public:
	enum Visibility
	{
        ...
        gSatWrapper(string designation, string tle1,string tle2);
        gSatWrapper(string designation,double epochJD, double ecco,double argpo,double inclo,double mo,double no,double nodeo);
        ~gSatWrapper();
    ...
    void resetPara( double epochJD,double ecco,double argpo,double inclo,double mo,double no,double nodeo);
